...
{
    public class Category_62131673Controller : Controller
    {
       private ApplicationDbContext db = new ApplicationDbContext();
        

        // GET: Admin/Category_62131673
        ...
        public ActionResult Add(Category_62131673 model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Category_62131673 model)
        {
            if (ModelState.IsValid)
            {
