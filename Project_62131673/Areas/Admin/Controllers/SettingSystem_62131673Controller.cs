...
{
    public class SettingSystem_62131673Controller : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();
        // GET: Admin/SettingSystem_62131673
        ...
        [HttpPost]
        public ActionResult AddSetting(SettingSystemViewModel_62131673 req)
        {
            SystemSetting_62131673 set = null;
            var checkTitle = db.SystemSettings.FirstOrDefault(x => x.SettingKey.Contains("SettingTitle"));
            if (checkTitle == null)
            {
                set = new SystemSetting_62131673();
