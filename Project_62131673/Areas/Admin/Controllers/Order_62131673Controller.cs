...
using Project_62131673.Models.ViewModels;

namespace Project_62131673.Areas.Admin.Controllers
{
    public class Order_62131673Controller : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();
        // GET: Admin/Order_62131673
...
on od.ProductId equals p.Id
            ...
            }).Select(x => new RevenueStatisticViewModel_62131673
            {
                Date = x.Date,
